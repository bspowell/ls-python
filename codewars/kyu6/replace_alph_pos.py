# make string into list without spaces
# create new array with for loop
# join into string with space
...
def alphabet_position(text):
    return ' '.join([str(ALPHA.index(ltr)) for ltr in text.lower() if ltr.isalpha()])
